...
from .models import Locion, Profile
...
def lista_lociones(request, user_id=None):
    lociones = Locion.objects.all()
    profile = None    
    if user_id:
    ...
    return render(request, 'index.html', {'lociones': lociones, 'profile': profile,'current_page':'catalogo'})
